# OptimalWordleWord
Code and source data to try and find the optimal first Wordle Word by calculating expected information gain. Base e is used for entropy calculations. Does not take into consideration what your second, third, or fourth word will be.
